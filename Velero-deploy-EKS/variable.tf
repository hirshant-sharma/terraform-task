...
variable "cluster_identity_oidc_issuer" {
  type        = string
  default     = "https://oidc.eks.me-central-1.amazonaws.com/id/00DE31575681CBFC505A02D7765E54AE"
  description = "The OIDC Identity issuer for the cluster."
}

variable "cluster_identity_oidc_issuer_arn" {
  type        = string
  default     = "arn:aws:iam::312989454747:role/eksctl-prod-eks-cluster-ServiceRole-vC8jyC7LD343"
